...
function Shell({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-[100dvh] bg-[#09090b] flex items-center justify-center px-4 py-8 sm:px-6">
...
export default async function ReviewPage({ params }: Props) {
  ...
  return (
    <Shell>
      <article className="overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03] shadow-2xl shadow-black/40 backdrop-blur-sm">
        <header className="border-b border-white/8 px-6 pb-6 pt-8 text-center">
          <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.18em] text-emerald-400">
